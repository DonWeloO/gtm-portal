...
class Agenda(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'agenda'
        unique_together = (('idagenda', 'fechaagenda'),)
...
class AuthUser(models.Model):
    ...
    rutusuario = models.CharField(max_length=10, blank=True, null=True)
...
class DetalleAgenda(models.Model):
    iddetalleagenda = models.AutoField(primary_key=True)
    idagenda = models.ForeignKey(Agenda, models.DO_NOTHING, related_name='agenda_id', db_column='idagenda')
    fechaagenda = models.ForeignKey(Agenda, models.DO_NOTHING,  related_name='agenda_fecha', db_column='fechaagenda')
    idhora = models.ForeignKey('HoraAgenda', models.DO_NOTHING, db_column='idhora')
    idsolicitud = models.ForeignKey('SolicitudDiag', models.DO_NOTHING, db_column='idsolicitud', blank=True, null=True)
...
class DetalleEspecialidad(models.Model):
    iddetalleesp = models.AutoField(primary_key=True)
...
class IngresoVehiculo(models.Model):
    ...
    idtaller = models.ForeignKey('TallerMecanico', models.DO_NOTHING, db_column='idtaller')
    idcliente = models.ForeignKey(ClienteTaller, models.DO_NOTHING, db_column='idcliente')
    patente = models.ForeignKey('VehiculoTaller', models.DO_NOTHING, db_column='patente')
...
class SolicitudDiag(models.Model):
    ...
    motivo = models.CharField(max_length=500)
    idcliente = models.ForeignKey(ClientePortal, models.DO_NOTHING, db_column='idcliente')
    idestadosol = models.ForeignKey(EstadoSolicitud, models.DO_NOTHING, db_column='idestadosol')
    patente = models.ForeignKey('VehiculoPortal', models.DO_NOTHING, db_column='patente')
    idtaller = models.ForeignKey('TallerMecanico', models.DO_NOTHING, db_column='idtaller')
...
class VehiculoPortal(models.Model):
